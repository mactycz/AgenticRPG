...
class AppState:
    def __init__(self):
        ...
        self.dropdown_options_llm = ['Local','Huggingface API','OpenAI','Anthropic','OpenRouter','Deepinfra']
        self.dropdown_options_image = ['Local','Huggingface API','OpenAI','Deepinfra']
